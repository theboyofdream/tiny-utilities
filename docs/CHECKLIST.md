...
- [x] Tiny Window Switcher (`src/window-switcher.c`, `docs/window-switcher.md` — updated 2026-09-07):
  ...
  - Centered Grid Container Layout (`--layout center` default, floating cards directly on screen backdrop without outer container box/border, max 5 columns per row), or `--layout full` (100% display edge-to-edge expansion with status header text aligned precisely to column 0 left boundary).
